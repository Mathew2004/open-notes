...
<div class="container">
    ...
    <div class="form-container">
        ...
        <form action="{{url('/note/edit/' . $note->id)}}" method="post" enctype="multipart/form-data"> @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="desc" id="desc" value="{{$note->desc}}" required>
            </div>
            ...
            <div class="collapse" id="link">
                <div class="form-group">
                    ...
                    <input type="text" id="" name="link" value="{{$note->link}}">
                </div>
            </div>
            <div class="collapse" id="file">
                <div class="form-group">
                    ...
                    <input type="file" name="file" value="{{$note->file}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="thumb-select" name="thumb" required>
                    <option value="{{$note->thumbnail}}">{{$note->subject}}</option>
            ...
            <div id="image-container" style="margin-top: 20px;">
                <img id="selected-image" src="{{$note->thumbnail}}" alt="Selected Thumbnail" style="display: block; max-width: 100%;">
            </div>
